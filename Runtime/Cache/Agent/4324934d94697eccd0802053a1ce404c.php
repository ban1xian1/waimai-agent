...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('Index/jclist');?>">商品管理</a> &gt;&gt;</span>
			<span class="h1-title"><?php if(empty($data)): ?>商品管理<?php else: ?>编辑商品<?php endif; ?></span>
		</div>
		<div class="tab-wrap">
						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									...
									<td><input type="text" class="form-control input-10x" name="real_price" value="<?php echo ($data["real_price"]); ?>"></td>
									<!--<td class="item-note" style="color:red;">*留空不更新</td>-->
								</tr>
								<tr class="controls">
									<td class="item-label">回收价格 :</td>
									<td><input type="text" class="form-control input-10x" name="recycling_price" value="<?php echo ($data["recycling_price"]); ?>">
									</td>
									<!--<td class="item-note" style="color:red;">*留空不更新</td>-->
								</tr>
								...
								<tr class="controls">
									...
									<td>
										<div class="form-item cf">
											...
											<a class="btn btn-return" href="<?php echo U('Index/jclist');?>">返 回</a>
