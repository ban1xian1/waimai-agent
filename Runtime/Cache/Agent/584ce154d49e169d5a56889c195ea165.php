	...
	<div id="main" class="main">
		...
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('Index/editUser');?>" method="post" class="form-horizontal">
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								<tr class="controls">
									<td class="item-label">冻结金额:</td>
									<td><input type="text" class="form-control input-10x" name="user_money_frozen" value="<?php echo ($data["user_money_frozen"]); ?>"></td>
