...
return [
    ...
    "没有公告发布"  => "No announcements were made",
    "建仓" => "Buy",
    "正在结算中" => "Billing",
    "继续下单" => "Continue",
    "发布时间"  => "Time",
	...
	"提币地址管理" => "Bank account management",
	"添加" => "Add",
	"没有保存地址" => "No bank account linked",
	"折合" => "Equivalent",
	"去交易" => "To trade",
	...
	"币种列表" => "Currency list",
	"不支持充币" => "Not support",
	"充币记录" => "Recharge record",
	"币种" => "Currency",
	"确认中" => "Confirmation in progress",
	"原路返回" => "Return",
	"充币网络" => "Network",
	"充币地址" => "Recharge account",
	"复制地址" => "Copy",
	...
	"最小充值金额" => "Minimum recharge amount",
	"小于最小金额的充值将不会上账且无法退回" => "Recharge less than the minimum amount will not be credited and cannot be returned",
	"您的充值地址不会经常改变，可以重复充值；如有更改，我们会尽量通过网站公告或邮件通知您" => "Your recharge account will not change frequently, and you can recharge repeatedly; If there is any change, we will try our best to notify you through website announcement or email",
	...
	"确定" => "Determine",
	"添加提币地址" => "Add bank account",
	"提币网络" => "Network",
	"输入或长按粘贴地址" => "Please fill in the bank account",
	"输入或长按粘贴账号" => "Please fill in the bank account",
	"输入或长按粘贴IFSC" => "Please fill in the IFSC",
	"备注" => "Remarks",
	"请输入备注" => "Please enter comments",
	"保存" => "Preservation",
	"请输入提币地址" => "Please fill in the bank account",
	"请输入IFSC" => "Please fill in the IFSC",
	"参数错误" => "Parameter error",
	"没有保存地址" => "No bank account linked",
	"添加地址" => "Add bank account",
	...
	"地址" => "Address",
	"关闭" => "Close",
	"地址管理" => "Bank account management",
	"暂时没有已保存地址" => "Temporarily no saved bank account",
	"去添加" => "To add",
	...
	"添加失败" => "Add failed",
	"提币地址不存在" => "Withdrawal bank account does not exist",
	"删除失败" => "Deletion failed",
	"请输入正确充值数量" => "Please enter the correct recharge quantity",
	"请上传转账凭证" => "Please upload transfer voucher",
	"低于最低额度" => "Cannot be less than the minimum recharge",
	...
	"秒合约已平仓，请及时加仓" => "The contract has been settled, please check.",
	...
	"您的充币记录被系统驳回，请联系客服" => "Your recharge record has been rejected by the system. Please contact customer service",
	"充币审核" => "Currency recharge approval",
	"登陆" => "Sign in",
	"邮箱" => "Mailbox",
	"认购上限" => "Limit",
	...
	'银行账号'  => "Bank Account",
	'IFSC'  => 'IFSC',
	'提币驳回'  => 'Withdrawal failed',
	'确认中'  => 'Pending',
	'暂时没有数据'  => 'Temporarily no data',
	'原路返回'  => 'Fail',
	'银行信息已绑定'  => 'The bank information has been bound',
	 "请先设置提现密码" => "Please set the withdrawal password first",
